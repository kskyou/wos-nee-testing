...
problem = (boundary_square, point_middle, f3)
...
if __name__ == "__main__":
    ...
    walks = [walk_naive, walk_cap, walk_cap_mis]
    for walk in walks:
        results = []
        for i in range(100):
            results.append(estimate_solution(walk, nWalks, problem))
